...
def downgrade():
    ...
    op.add_column(
        'user', sa.Column('lastUpdate', sa.DATE(), autoincrement=False, nullable=False)
    )
    op.add_column(
        'user', sa.Column('createdAt', sa.DATE(), autoincrement=False, nullable=False)
    )
    ...
    op.add_column(
        'social_worker',
        sa.Column('lastUpdateDate', sa.DATE(), autoincrement=False, nullable=False),
    )
