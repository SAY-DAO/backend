...
def upgrade():
    ...
    op.create_foreign_key(
        op.f('activity_id_social_worker_social_worker_fkey'),
        'activity',
        'social_worker',
        ['id_social_worker'],
        ['id'],
    ...
    op.create_foreign_key(
        op.f('child_id_social_worker_social_worker_fkey'),
        'child',
        'social_worker',
        ['id_social_worker'],
        ['id'],
    ...
    op.create_foreign_key(
        op.f('child_id_ngo_ngo_fkey'), 'child', 'ngo', ['id_ngo'], ['id']
    )
    op.alter_column(
        'need',
        'oncePurchased',
    ...
    op.create_foreign_key(
        op.f('need_child_id_child_fkey'), 'need', 'child', ['child_id'], ['id']
    )
    ...
    op.create_foreign_key(
        op.f('ngo_coordinatorId_social_worker_fkey'),
        'ngo',
        'social_worker',
        ['coordinatorId'],
        ['id'],
    ...
    op.create_foreign_key(
        op.f('social_worker_id_ngo_ngo_fkey'),
        'social_worker',
        'ngo',
        ['id_ngo'],
        ['id'],
    ...
    op.create_foreign_key(
        op.f('social_worker_id_type_social_worker_type_fkey'),
        'social_worker',
        'social_worker_type',
        ['id_type'],
        ['id'],
    ...
    op.create_unique_constraint(
        op.f('social_worker_type_id_key'), 'social_worker_type', ['id']
    )
    op.alter_column('user', 'isVerified', existing_type=sa.BOOLEAN(), nullable=False)
...
def downgrade():
    ...
    op.add_column(
        'user', sa.Column('token', sa.VARCHAR(), autoincrement=False, nullable=True)
    )
    op.add_column(
        'user', sa.Column('verifyDate', sa.DATE(), autoincrement=False, nullable=True)
    )
    op.drop_constraint(op.f('user_id_key'), 'user', type_='unique')
    op.alter_column('user', 'isVerified', existing_type=sa.BOOLEAN(), nullable=True)
    op.drop_constraint(
        op.f('social_worker_type_id_key'), 'social_worker_type', type_='unique'
    )
    op.drop_constraint(
        op.f('social_worker_id_type_social_worker_type_fkey'),
        'social_worker',
    ...
    op.drop_constraint(
        op.f('social_worker_id_ngo_ngo_fkey'), 'social_worker', type_='foreignkey'
    )
    ...
    op.drop_constraint(
        op.f('ngo_coordinatorId_social_worker_fkey'), 'ngo', type_='foreignkey'
    )
    op.create_foreign_key(
        'ngo_coordinator_id_fkey',
        'ngo',
        'social_worker',
        ['coordinatorId'],
        ['id'],
    ...
    op.create_foreign_key(
        'need_child_id_fkey', 'need', 'child', ['child_id'], ['id'], ondelete='CASCADE'
    )
    ...
    op.drop_constraint(
        op.f('child_id_social_worker_social_worker_fkey'), 'child', type_='foreignkey'
    )
