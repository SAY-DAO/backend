...
def upgrade():
    ...
    op.create_index(
        op.f('child_id_social_worker_idx'), 'child', ['id_social_worker'], unique=False
    )
    op.create_index(op.f('need_child_id_idx'), 'need', ['child_id'], unique=False)
    op.create_index(
        op.f('need_family_id_family_idx'), 'need_family', ['id_family'], unique=False
    )
    op.create_index(
        op.f('need_family_id_need_idx'), 'need_family', ['id_need'], unique=False
    )
    op.create_index(
        op.f('need_family_id_user_idx'), 'need_family', ['id_user'], unique=False
    )
    op.create_index(
        op.f('need_receipt_need_id_idx'), 'need_receipt', ['need_id'], unique=False
    )
    op.create_index(
        op.f('need_receipt_receipt_id_idx'),
        'need_receipt',
        ['receipt_id'],
        unique=False,
    )
    op.create_index(
        op.f('need_receipt_sw_id_idx'), 'need_receipt', ['sw_id'], unique=False
    )
    ...
    op.create_index(
        op.f('reset_password_user_id_idx'), 'reset_password', ['user_id'], unique=False
    )
    op.create_index(
        op.f('social_worker_id_ngo_idx'), 'social_worker', ['id_ngo'], unique=False
    )
    op.create_index(
        op.f('social_worker_id_type_idx'), 'social_worker', ['id_type'], unique=False
    )
    op.create_index(
        op.f('user_family_id_family_idx'), 'user_family', ['id_family'], unique=False
    )
    op.create_index(
        op.f('user_family_id_user_idx'), 'user_family', ['id_user'], unique=False
    )
